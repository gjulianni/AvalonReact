...
<body>
	...
	if (!isset($_SESSION['steamid'])) {
		echo "<nav class='nav'>
		<button onclick='toggleSidebar()' class='checkbtn'>
...
<div class="col-sm-6 col-md-4 col-lg-3 mb-3 mx-2">
				...
				<div class="card-footer">
					<form action="" method="POST">
						<select name="forma" class="form-control select" onchange="this.form.submit()" class="SelectWeapon">
							<option disabled>Selecione a faca</option>
							<?php
			...
			<div class="col-sm-2">
				<div class="card text-center mb-3">
					...
					<div class="card-footer">
						<form action="" method="POST">
							<select name="forma" class="form-control select" onchange="this.form.submit()" class="SelectWeapon">
								<option disabled>Selecione a skin</option>
								<?php
							...
							<?php else : ?>
								...
								<script>
									function showSkinSelectionAlert() {
										alert("Você precisa selecionar uma skin primeiro.");
									}
								</script>
							<?php endif; ?>
								...
								<div class="modal-body">
									<div class="form-group">
										<select class="form-select" id="wearSelect<?php echo $defindex ?>" name="wearSelect" onchange="updateWearValue<?php echo $defindex ?>(this.value)">
											<option disabled>Selecione o estado da arma</option>
											<option value="0.00" <?php echo ($initialWearValue == 0.00) ? 'selected' : ''; ?>>Nova de Fábrica</option>
											<option value="0.07" <?php echo ($initialWearValue == 0.07) ? 'selected' : ''; ?>>Pouco Usada</option>
											<option value="0.15" <?php echo ($initialWearValue == 0.15) ? 'selected' : ''; ?>>Testada em Campo</option>
											<option value="0.38" <?php echo ($initialWearValue == 0.38) ? 'selected' : ''; ?>>Bem desgastada</option>
											<option value="0.45" <?php echo ($initialWearValue == 0.45) ? 'selected' : ''; ?>>Veterana de Guerra</option>
										</select>
